...
export const LINK_CURATED = 'link_curated'
export const LINK_CURATED_WITH_LINKS = 'link_curated_with_links'
...
export const ARCHIVING_LINK = 'archiving_link'
...
export const ACTIVE_CONVERSATION_SET = 'active_conversation_set'
export const CONVERSATIONS_SET = 'conversations_set'
export const CONVERSATION_MESSAGES_SET = 'conversation_messages_set'
